...
public class MainguiController {
    ...
    private void CambiarEstilo() {
        ...
        switch(estilo){
            case "Estilo oscuro":
                scene.getStylesheets().add(getClass().getResource("/css/estilosOscuro.css").toExternalForm()); break;
            case "Estilo Azul":
                scene.getStylesheets().add(getClass().getResource("/css/estilosAzul.css").toExternalForm()); break;
            case "Estilo Rosado":
                scene.getStylesheets().add(getClass().getResource("/css/estilosRosado.css").toExternalForm()); break;
            case "Estilo Verde":
                scene.getStylesheets().add(getClass().getResource("/css/estilosVerde.css").toExternalForm()); break;
                default:break;
        }
    }
